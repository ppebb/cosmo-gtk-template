...
struct gtk_syms {
    ...
    GBytes * (*gtk_builder_list_item_factory_get_bytes)(GtkBuilderListItemFactory *sel);
    const char * (*gtk_builder_list_item_factory_get_resource)(GtkBuilderListItemFactory *sel);
    GtkBuilderScope * (*gtk_builder_list_item_factory_get_scope)(GtkBuilderListItemFactory *sel);
    ...
    guint (*gtk_column_view_cell_get_position)(GtkColumnViewCell *sel);
    gboolean (*gtk_column_view_cell_get_selected)(GtkColumnViewCell *sel);
    gboolean (*gtk_column_view_cell_get_focusable)(GtkColumnViewCell *sel);
    ...
    guint (*gtk_column_view_row_get_position)(GtkColumnViewRow *sel);
    gboolean (*gtk_column_view_row_get_selected)(GtkColumnViewRow *sel);
    gboolean (*gtk_column_view_row_get_selectable)(GtkColumnViewRow *sel);
    void (*gtk_column_view_row_set_selectable)(GtkColumnViewRow *self, gboolean selectable);
    gboolean (*gtk_column_view_row_get_activatable)(GtkColumnViewRow *sel);
    void (*gtk_column_view_row_set_activatable)(GtkColumnViewRow *self, gboolean activatable);
    gboolean (*gtk_column_view_row_get_focusable)(GtkColumnViewRow *sel);
    ...
    guint (*gtk_list_header_get_start)(GtkListHeader *sel);
    guint (*gtk_list_header_get_end)(GtkListHeader *sel);
    guint (*gtk_list_header_get_n_items)(GtkListHeader *sel);
    ...
    guint (*gtk_list_item_get_position)(GtkListItem *sel);
    gboolean (*gtk_list_item_get_selected)(GtkListItem *sel);
    gboolean (*gtk_list_item_get_selectable)(GtkListItem *sel);
    void (*gtk_list_item_set_selectable)(GtkListItem *self, gboolean selectable);
    gboolean (*gtk_list_item_get_activatable)(GtkListItem *sel);
    void (*gtk_list_item_set_activatable)(GtkListItem *self, gboolean activatable);
    gboolean (*gtk_list_item_get_focusable)(GtkListItem *sel);
    ...
    const char * (*gtk_widget_get_css_name)(GtkWidget *sel);
    ...
    GListModel * (*gdk_display_get_monitors)(GdkDisplay *sel);
    ...
    gsize (*gdk_dmabuf_formats_get_n_formats)(GdkDmabufFormats *format);
    void (*gdk_dmabuf_formats_get_format)(GdkDmabufFormats *formats, gsize idx, guint32 *fourcc, guint64 *modifier);
    gboolean (*gdk_dmabuf_formats_contains)(GdkDmabufFormats *formats, guint32 fourcc, guint64 modifie);
    ...
    gboolean (*gdk_rectangle_equal)(const GdkRectangle *rect1, const GdkRectangle *rect);
    gboolean (*gdk_rectangle_contains_point)(const GdkRectangle *rect, int x, int );
    ...
    gboolean (*gdk_rgba_is_clear)(const GdkRGBA *rgb);
    gboolean (*gdk_rgba_is_opaque)(const GdkRGBA *rgb);
    guint (*gdk_rgba_hash)(gconstpointer );
    gboolean (*gdk_rgba_equal)(gconstpointer p1, gconstpointer p);
    ...
    int (*gdk_texture_get_width)(GdkTexture *textur);
    int (*gdk_texture_get_height)(GdkTexture *textur);
    GdkMemoryFormat (*gdk_texture_get_format)(GdkTexture *sel);
    ...
    GskPath * (*gsk_path_measure_get_path)(GskPathMeasure *sel);
    float (*gsk_path_measure_get_tolerance)(GskPathMeasure *sel);
    ...
    gboolean (*gsk_path_point_equal)(const GskPathPoint *point1, const GskPathPoint *point);
    int (*gsk_path_point_compare)(const GskPathPoint *point1, const GskPathPoint *point);
    ...
    GskRenderNode * (*gsk_debug_node_get_child)(const GskRenderNode *nod);
    const char * (*gsk_debug_node_get_message)(const GskRenderNode *nod);
    GType (*gsk_color_node_get_type)(void);
    GskRenderNode * (*gsk_color_node_new)(const GdkRGBA *rgba, const graphene_rect_t *bounds);
    const GdkRGBA * (*gsk_color_node_get_color)(const GskRenderNode *nod);
    GType (*gsk_texture_node_get_type)(void);
    GskRenderNode * (*gsk_texture_node_new)(GdkTexture *texture, const graphene_rect_t *bounds);
    GdkTexture * (*gsk_texture_node_get_texture)(const GskRenderNode *nod);
    ...
    GdkTexture * (*gsk_texture_scale_node_get_texture)(const GskRenderNode *nod);
    GskScalingFilter (*gsk_texture_scale_node_get_filter)(const GskRenderNode *nod);
    ...
    const graphene_point_t * (*gsk_linear_gradient_node_get_start)(const GskRenderNode *nod);
    const graphene_point_t * (*gsk_linear_gradient_node_get_end)(const GskRenderNode *nod);
    gsize (*gsk_linear_gradient_node_get_n_color_stops)(const GskRenderNode *nod);
    ...
    const graphene_point_t * (*gsk_conic_gradient_node_get_center)(const GskRenderNode *nod);
    float (*gsk_conic_gradient_node_get_rotation)(const GskRenderNode *nod);
    float (*gsk_conic_gradient_node_get_angle)(const GskRenderNode *nod);
    gsize (*gsk_conic_gradient_node_get_n_color_stops)(const GskRenderNode *nod);
    ...
    gsize (*gsk_radial_gradient_node_get_n_color_stops)(const GskRenderNode *nod);
    const GskColorStop * (*gsk_radial_gradient_node_get_color_stops)(const GskRenderNode *node, gsize *n_stops);
    const graphene_point_t* (*gsk_radial_gradient_node_get_center)(const GskRenderNode *nod);
    float (*gsk_radial_gradient_node_get_hradius)(const GskRenderNode *nod);
    float (*gsk_radial_gradient_node_get_vradius)(const GskRenderNode *nod);
    float (*gsk_radial_gradient_node_get_start)(const GskRenderNode *nod);
    float (*gsk_radial_gradient_node_get_end)(const GskRenderNode *nod);
    ...
    const GskRoundedRect * (*gsk_border_node_get_outline)(const GskRenderNode *nod);
    const float * (*gsk_border_node_get_widths)(const GskRenderNode *nod);
    const GdkRGBA * (*gsk_border_node_get_colors)(const GskRenderNode *nod);
    ...
    const GskRoundedRect * (*gsk_inset_shadow_node_get_outline)(const GskRenderNode *nod);
    const GdkRGBA * (*gsk_inset_shadow_node_get_color)(const GskRenderNode *nod);
    float (*gsk_inset_shadow_node_get_dx)(const GskRenderNode *nod);
    float (*gsk_inset_shadow_node_get_dy)(const GskRenderNode *nod);
    float (*gsk_inset_shadow_node_get_spread)(const GskRenderNode *nod);
    float (*gsk_inset_shadow_node_get_blur_radius)(const GskRenderNode *nod);
    ...
    const GskRoundedRect * (*gsk_outset_shadow_node_get_outline)(const GskRenderNode *nod);
    const GdkRGBA * (*gsk_outset_shadow_node_get_color)(const GskRenderNode *nod);
    float (*gsk_outset_shadow_node_get_dx)(const GskRenderNode *nod);
    float (*gsk_outset_shadow_node_get_dy)(const GskRenderNode *nod);
    float (*gsk_outset_shadow_node_get_spread)(const GskRenderNode *nod);
    float (*gsk_outset_shadow_node_get_blur_radius)(const GskRenderNode *nod);
    ...
    guint (*gsk_container_node_get_n_children)(const GskRenderNode *nod);
    GskRenderNode * (*gsk_container_node_get_child)(const GskRenderNode *node, guint id);
    GType (*gsk_transform_node_get_type)(void);
    GskRenderNode * (*gsk_transform_node_new)(GskRenderNode *child, GskTransform *transform);
    GskRenderNode * (*gsk_transform_node_get_child)(const GskRenderNode *nod);
    GskTransform * (*gsk_transform_node_get_transform)(const GskRenderNode *nod);
    GType (*gsk_opacity_node_get_type)(void);
    GskRenderNode * (*gsk_opacity_node_new)(GskRenderNode *child, float opacity);
    GskRenderNode * (*gsk_opacity_node_get_child)(const GskRenderNode *nod);
    float (*gsk_opacity_node_get_opacity)(const GskRenderNode *nod);
    ...
    GskRenderNode * (*gsk_color_matrix_node_get_child)(const GskRenderNode *nod);
    const graphene_matrix_t * (*gsk_color_matrix_node_get_color_matrix)(const GskRenderNode *nod);
    const graphene_vec4_t * (*gsk_color_matrix_node_get_color_offset)(const GskRenderNode *nod);
    ...
    GskRenderNode * (*gsk_repeat_node_get_child)(const GskRenderNode *nod);
    const graphene_rect_t * (*gsk_repeat_node_get_child_bounds)(const GskRenderNode *nod);
    GType (*gsk_clip_node_get_type)(void);
    GskRenderNode * (*gsk_clip_node_new)(GskRenderNode *child, const graphene_rect_t *clip);
    GskRenderNode * (*gsk_clip_node_get_child)(const GskRenderNode *nod);
    const graphene_rect_t * (*gsk_clip_node_get_clip)(const GskRenderNode *nod);
    ...
    GskRenderNode * (*gsk_rounded_clip_node_get_child)(const GskRenderNode *nod);
    const GskRoundedRect * (*gsk_rounded_clip_node_get_clip)(const GskRenderNode *nod);
    ...
    GskRenderNode * (*gsk_shadow_node_get_child)(const GskRenderNode *nod);
    const GskShadow * (*gsk_shadow_node_get_shadow)(const GskRenderNode *node, gsize );
    gsize (*gsk_shadow_node_get_n_shadows)(const GskRenderNode *nod);
    ...
    GskRenderNode * (*gsk_blend_node_get_bottom_child)(const GskRenderNode *nod);
    GskRenderNode * (*gsk_blend_node_get_top_child)(const GskRenderNode *nod);
    GskBlendMode (*gsk_blend_node_get_blend_mode)(const GskRenderNode *nod);
    ...
    GskRenderNode * (*gsk_cross_fade_node_get_start_child)(const GskRenderNode *nod);
    GskRenderNode * (*gsk_cross_fade_node_get_end_child)(const GskRenderNode *nod);
    float (*gsk_cross_fade_node_get_progress)(const GskRenderNode *nod);
    ...
    PangoFont * (*gsk_text_node_get_font)(const GskRenderNode *nod);
    gboolean (*gsk_text_node_has_color_glyphs)(const GskRenderNode *nod);
    guint (*gsk_text_node_get_num_glyphs)(const GskRenderNode *nod);
    const PangoGlyphInfo* (*gsk_text_node_get_glyphs)(const GskRenderNode *node, guint *n_glyphs);
    const GdkRGBA * (*gsk_text_node_get_color)(const GskRenderNode *nod);
    const graphene_point_t* (*gsk_text_node_get_offset)(const GskRenderNode *nod);
    GType (*gsk_blur_node_get_type)(void);
    GskRenderNode * (*gsk_blur_node_new)(GskRenderNode *child, float radius);
    GskRenderNode * (*gsk_blur_node_get_child)(const GskRenderNode *nod);
    float (*gsk_blur_node_get_radius)(const GskRenderNode *nod);
    ...
    guint (*gsk_gl_shader_node_get_n_children)(const GskRenderNode *nod);
    GskRenderNode * (*gsk_gl_shader_node_get_child)(const GskRenderNode *node, guint id);
    GBytes * (*gsk_gl_shader_node_get_args)(const GskRenderNode *nod);
    GskGLShader * (*gsk_gl_shader_node_get_shader)(const GskRenderNode *nod);
    GType (*gsk_subsurface_node_get_type)(void);
    GskRenderNode * (*gsk_subsurface_node_new)(GskRenderNode *child, gpointer subsurface);
    GskRenderNode * (*gsk_subsurface_node_get_child)(const GskRenderNode *nod);
    ...
    gboolean (*gsk_rounded_rect_is_rectilinear)(const GskRoundedRect *sel);
    gboolean (*gsk_rounded_rect_contains_point)(const GskRoundedRect *self, const graphene_point_t *poin);
    gboolean (*gsk_rounded_rect_contains_rect)(const GskRoundedRect *self, const graphene_rect_t *rec);
    gboolean (*gsk_rounded_rect_intersects_rect)(const GskRoundedRect *self, const graphene_rect_t *rec);
    ...
    GskTransformCategory (*gsk_transform_get_category)(GskTransform *sel);
    gboolean (*gsk_transform_equal)(GskTransform *first, GskTransform *secon);
