...
struct glib_syms {
    ...
    gunichar (*g_utf8_get_char_validated)(const gchar *p, gssize max_le);
    gchar* (*g_utf8_offset_to_pointer)(const gchar *str, glong offse);
    glong (*g_utf8_pointer_to_offset)(const gchar *str, const gchar *po);
    gchar* (*g_utf8_prev_char)(const gchar *);
    gchar* (*g_utf8_find_next_char)(const gchar *p, const gchar *en);
    gchar* (*g_utf8_find_prev_char)(const gchar *str, const gchar *);
    glong (*g_utf8_strlen)(const gchar *p, gssize ma);
    ...
    gint (*g_utf8_collate)(const gchar *str1, const gchar *str);
    ...
    gboolean (*g_type_check_instance_is_a)(GTypeInstance *instance, GType iface_typ);
    gboolean (*g_type_check_instance_is_fundamentally_a)(GTypeInstance *instance, GType fundamental_typ);
    GTypeClass* (*g_type_check_class_cast)(GTypeClass *g_class, GType is_a_type);
    gboolean (*g_type_check_class_is_a)(GTypeClass *g_class, GType is_a_typ);
    gboolean (*g_type_check_is_value_type)(GType type);
    gboolean (*g_type_check_value)(const GValue *valu);
    gboolean (*g_type_check_value_holds)(const GValue *value, GType typ);
    ...
    void (*g_task_return_prefixed_error)(GTask *task, GError *error, const char *format, ...);
